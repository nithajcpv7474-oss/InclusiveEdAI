                  ...
                  <div className="flex items-center gap-2">
                    {isRecording ? (
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-indigo-600 hover:bg-indigo-705 text-white rounded-xl text-xs font-bold transition-all uppercase tracking-wider flex items-center gap-1.5 shadow-md shadow-indigo-650/10 hover:scale-[1.01]"
                      >
              ...
              return (
                <button
                  ...
                  className={`p-5 rounded-3xl border text-left flex items-start gap-4 transition-all hover:scale-[1.01] ${
                    isSelected
                      ? 'border-indigo-650 bg-indigo-500/5 dark:border-indigo-500 dark:bg-indigo-500/10'
          ...
          <div className="p-6 bg-indigo-500/5 border border-indigo-500/20 dark:border-indigo-900/40 rounded-3xl space-y-3.5 animate-in fade-in duration-200">
            <div className="space-y-1">
              <h3 className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-widest flex items-center gap-1.5">
                <Languages className="w-4 h-4 text-indigo-650 dark:text-indigo-400" />
